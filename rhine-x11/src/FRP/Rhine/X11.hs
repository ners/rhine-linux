...
import           FRP.Rhine
import           Graphics.X11              (allocaSetWindowAttributes,
                                            cWEventMask, propertyChangeMask,
                                            set_event_mask)
...
import           Graphics.X11.Xlib.Extras  (Event, changeWindowAttributes,
                                            getEvent)
import           Graphics.X11.Xrandr       (xrrQueryExtension,
